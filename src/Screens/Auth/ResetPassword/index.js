...
import { getFontSize, getHeight, getWidth,
    ...
    if (!newPasswordError && !cpasswordError &&newPassword==cpassword) {
      ...
      try {
        const res = await ApiCall({ 
          params: {email:email,password:newPassword,confirm_password:cpassword},
...
<Text style={styles.stxt}>Reset your password</Text>
          <KeyboardAwareScrollView
            ...
            <TextInput
              ...
              onChangeText={newPassword => changeHandler('newPassword', newPassword.trim())}
              blurOnSubmit={false}
            />
            <Text  style={{...GernalStyle.InputError,marginLeft:getWidth(7)}}>{state.newPasswordError}</Text>
            <TextInput
              mode="outlined"
              // label="Confirm new password"
              label={<Text style={GernalStyle.inputLabelStyle}>Confirm new password</Text>} 
            ...
            <Text style={{...GernalStyle.InputError,marginLeft:getWidth(7)}}>{state.cpasswordError}</Text>
