  ...
  return (
    <View style={{...GernalStyle.continer, backgroundColor: colors.homeColor}}>
      ...
      <View
        ...
        <View style={{...styles.angel,justifyContent:"space-between",alignSelf:"center",marginRight:getWidth(3),backgroundColor:'#000'}}>
          ...
          <TouchableOpacity style={{...styles.togle,marginRight:getWidth(2)}} onPress={toggleTimer}>
            {isRunning ? (
      ...
      <TouchableOpacity
        ...
        <Text style={styles.markas}>Mark as completed</Text>
      </TouchableOpacity>
    </View>
  );
};
