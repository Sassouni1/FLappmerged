...
import {Text, View, TouchableOpacity, Image, Animated, FlatList, ScrollView, ImageBackground, StatusBar} from 'react-native';
        ...
        <View style={{...styles.eliteCon, marginBottom: getHeight(1.5)}}>
          <View style={styles.imageCon}>
            ...
            <View style={{...styles.greenbtn, backgroundColor: colors.white}}>
              <Text style={{...styles.call, color: colors.secondary}}>Shop</Text>
            </View>
          </View>
          <Text
            style={{
