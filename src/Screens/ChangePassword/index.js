...
const ChangePassword = ({navigation}) => {
  ...
  const PasswordUpdate = async () => {
    ...
    if (!cnfrPasswordError && !newPasswordError && !oldPasswordError&& newPassword==cnfrPassword) {
      ...
      if(newPasswordError || cnfrPasswordError|| oldPasswordError){
        setState({...state, cnfrPasswordError, newPasswordError, oldPasswordError});
        return
      }else{
    ...
    <KeyboardAwareScrollView
      ...
      <View>
        <TextInput
          mode="outlined"
          // label="Old password"
          label={<Text style={GernalStyle.inputLabelStyle}>Old password</Text>} 
          ...
          blurOnSubmit={false}
        />
        <Text style={{...GernalStyle.InputError,marginLeft:getWidth(8)}}>{state.oldPasswordError}</Text>
      </View>
      <View>
        <TextInput
          mode="outlined"
        ...
        <Text style={{...GernalStyle.InputError,marginLeft:getWidth(8)}}>{state.newPasswordError}</Text>
      </View>
      <View>
        <TextInput
          mode="outlined"
         // label="Confirm password"
          label={<Text style={GernalStyle.inputLabelStyle}>Confirm password</Text>} 
        ...
        <Text style={{...GernalStyle.InputError,marginLeft:getWidth(8)}}>{state.cnfrPasswordError}</Text>
      </View>
      <Button
