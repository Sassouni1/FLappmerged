...
const WorkoutDetail1 = ({navigation}) => {
      ...
      <ScrollView>
        <View style={styles.main}>
          <Modal isVisible={isModalVisible}>
            <View style={styles.mainview}>
              ...
              <Image
                ...
                source={require('../../../assets/images/modelvideo.png')}
              />
              <TextInput
                mode="outlined"
                // label="Write comment"
              ...
              />
              {/* <LinearGradient colors={['#182d4a', '#7D5098']} 
                      style={{alignSelf: 'center',
                            width: getWidth(85),
                            height: getHeight(6),
                            justifyContent: 'center',
          ...
          <Modal isVisible={isModalVisible1}>
            <View style={{...styles.mainview, height: getHeight(80)}}>
              <View style={styles.secView}>
                <View></View>
                <Text style={{...styles.taskview}}>Submitted successfully</Text>
                {/* <TouchableOpacity
      onPress={toggleModal}>
        <Ionicons style={{
