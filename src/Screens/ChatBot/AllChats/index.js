...
const BotAllChatScreen = ({navigation, route}) => {
    ...
    const renderItem = ({item, index}) => <ChatsCard item={item} index={index} />
        ...
        <View style={styles.container}>
            ...
            <SectionList
                ...
                renderSectionHeader={({section: {title, horizontal, data}}) => (
                    <View style={title == 'Chats' ? styles.titleWrapperRow : styles.titleWrapper}>
                        <Text style={styles.headingText}>{title}</Text>
                        {title == 'Chats' && <Text style={[styles.sellAllText]}>{'See all'}</Text>}
                    </View>
                )}
