...
const LeaderBoard = () => {
  ...
  const topItemsMessages = showAllMessages ? dataMessages : dataMessages.slice(0, 5);
                  ...
                  >
                    ...
                    >
                      <View style={{ flex: 1 }}>
                        ...
                        >
                          {item?.userDetails?.profile_image && item?.userDetails?.profile_image != "" ? (
                            <View>
                              <Image
                                source={{ uri: item?.userDetails?.profile_image }}
                                style={styles.thumbnail}
                                resizeMode="cover"
                              ></Image>
                            </View>
