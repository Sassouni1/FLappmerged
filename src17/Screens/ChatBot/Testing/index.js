...
const TestChatSceen = ({navigation, route}) => {
    ...
    const renderItem = ({item, index}) => {
        return (
            <View style={{alignItems: 'center'}}>
                <View style={[styles.leftIconWrpper]}>{<Image source={item.image} style={styles.leftIcon} />}</View>
    ...
    return (
        <View style={styles.container}>
            ...
            <HeaderChatBot
                ...
                RightIcon={
                    <Pressable style={styles.headerIconWraaper} onPress={() => null}>
            ...
            <View style={[styles.chatContainer]}>
                {messages.length == 0 && (
                    <View style={{justifyContent: 'center', alignItems: 'center', top: getHeight(20)}}>
                        <Carousel ref={flatListRef} data={scrollData} renderItem={renderItem} sliderWidth={getWidth(100)} itemWidth={getWidth(100)} onScrollIndexChanged={(index) => setActiveIndex(index)} />
                        <Pagination dotsLength={scrollData.length} activeDotIndex={activeIndex} containerStyle={styles.dotsContainer} dotContainerStyle={{backgroundColor: colors.greyBg, borderRadius: 2, margin: 0, marginHorizontal: 2}} dotColor={colors.black} inactiveDotColor={colors.greyBg} />
                    </View>
                )}
                <GiftedChat
...
const scrollData = [
    {
        ...
        label: 'Limitations',
        description: 'No chatbots is perfect, just like human being. Fight Life AI chatbot’s knowledge is limited to 2025.'
    },
    {
        id: '2',
        image: require('../../../assets/images/support.png'),
